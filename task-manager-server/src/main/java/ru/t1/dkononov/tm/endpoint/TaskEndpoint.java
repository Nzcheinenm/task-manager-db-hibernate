...
public final class TaskEndpoint extends AbstractEndpoint implements ITaskEndpoint {
    ...
    public TaskGetByIdResponse getTaskById(
        ...
        @Nullable final String userId = session.getUserId();
        @Nullable final String id = request.getId();
        @Nullable final TaskDTO task = getTaskService().findById(userId, id);
    ...
    public TaskGetByIndexResponse getTaskByIndex(
        ...
        @Nullable final Integer index = request.getIndex();
        @Nullable final String userId = session.getUserId();
        @Nullable final TaskDTO task = getTaskService().findByIndex(userId, index);
    ...
    public TaskRemoveByIndexResponse removeTaskByIndex(
        ...
        @Nullable final String userId = session.getUserId();
        @Nullable final Integer index = request.getIndex();
        @Nullable final TaskDTO Task = getTaskService().removeById(userId, String.valueOf(index));
    ...
    public TaskStartByIdResponse startTaskById(
        ...
        @Nullable final String userId = session.getUserId();
        @Nullable final String id = request.getId();
        @Nullable final TaskDTO Task = getTaskService().changeTaskStatusById(userId, id, Status.IN_PROGRESS);
    ...
    public TaskStartByIndexResponse startTaskByIndex(
        ...
        @Nullable final String userId = session.getUserId();
        @Nullable final Integer index = request.getIndex();
        @Nullable final TaskDTO Task = getTaskService().changeTaskStatusByIndex(userId, index, Status.IN_PROGRESS);
    ...
    public TaskCompleteByIdResponse completeTaskById(
        ...
        @Nullable final String userId = session.getUserId();
        @Nullable final String id = request.getId();
        @Nullable final TaskDTO task = getTaskService().changeTaskStatusById(userId, id, Status.COMPLETED);
    ...
    public TaskCompleteByIndexResponse completeTaskByIndex(
        ...
        @Nullable final String userId = session.getUserId();
        @Nullable final Integer index = request.getIndex();
        @Nullable final TaskDTO task = getTaskService().changeTaskStatusByIndex(userId, index, Status.COMPLETED);
