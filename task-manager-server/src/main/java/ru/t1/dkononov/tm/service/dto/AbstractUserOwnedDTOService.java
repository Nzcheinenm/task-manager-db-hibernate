...
public abstract class AbstractUserOwnedDTOService<M extends AbstractUserOwnedModelDTO, R extends AbstractUserOwnedDTORepository<M>>
    ...
    public AbstractUserOwnedDTOService(@Nullable final IConnectionService connectionService) {
        super(connectionService);
    }

    @NotNull
    protected abstract IUserOwnedDTORepository getRepository(@NotNull final EntityManager entityManager);
